        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="animate-bounce mt-8">
              <ArrowDown className="h-8 w-8 text-yellow-300 mx-auto drop-shadow-[0_0_12px_rgba(250,204,21,0.8)]" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-slate-950/55">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="h-1 w-24 mx-auto rounded-full rainbow-bar shadow-[0_0_16px_rgba(139,92,246,0.45)]" />
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 backdrop-blur-md">
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-red-400 via-orange-400 to-yellow-300 p-4 rounded-full mr-5 shadow-[0_0_20px_rgba(249,115,22,0.45)]">
            ...
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 backdrop-blur-md">
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-cyan-400 via-blue-400 to-violet-400 p-4 rounded-full mr-5 shadow-[0_0_20px_rgba(59,130,246,0.45)]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">
                      ...
                      <a
                        ...
                        className="underline text-sky-300 cursor-pointer"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
      ...
      <section className="py-16 px-6 bg-slate-950/70">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="h-1 w-24 mx-auto rounded-full rainbow-bar shadow-[0_0_16px_rgba(34,197,94,0.45)]" />
          </div>

          <div className="rainbow-border rainbow-glow bg-slate-950/70 rounded-2xl overflow-hidden backdrop-blur-md">
            <div className="p-8 md:p-10">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-xl p-6 text-center border border-white/10">
                  <div className="bg-gradient-to-br from-red-400 to-orange-400 text-slate-950 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl shadow-[0_0_18px_rgba(239,68,68,0.4)]">
                    🔔
                  </div>
                ...
                <div className="bg-gradient-to-br from-amber-500/20 to-yellow-500/20 rounded-xl p-6 text-center border border-white/10">
                  <div className="bg-gradient-to-br from-amber-400 to-yellow-300 text-slate-950 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl shadow-[0_0_18px_rgba(234,179,8,0.4)]">
                    📱
                  </div>
                  <h3 className="font-bold text-lg mb-2 text-amber-200">Action</h3>
                ...
                <div className="bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 rounded-xl p-6 text-center border border-white/10">
                  <div className="bg-gradient-to-br from-emerald-400 to-cyan-400 text-slate-950 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl shadow-[0_0_18px_rgba(34,197,94,0.4)]">
                    🎉
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-500/20 to-violet-500/20 rounded-xl p-6 text-center border border-white/10">
                  <div className="bg-gradient-to-br from-blue-400 to-violet-400 text-slate-950 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl shadow-[0_0_18px_rgba(139,92,246,0.4)]">
                    🔁
                  </div>
                  <h3 className="font-bold text-lg mb-2 text-violet-200">Repeat</h3>
      ...
      <section className="py-16 px-6 bg-slate-950/55">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="h-1 w-24 mx-auto rounded-full rainbow-bar shadow-[0_0_16px_rgba(236,72,153,0.45)]" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 hover:shadow-[0_0_36px_rgba(239,68,68,0.22)] transition-all duration-300 hover:-translate-y-1 backdrop-blur-md">
              <div className="h-1 rainbow-bar opacity-80" />
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-red-400 to-orange-400 text-slate-950 w-12 h-12 rounded-full flex items-center justify-center mr-5 font-bold text-xl shrink-0 shadow-[0_0_14px_rgba(239,68,68,0.35)]">
                    1
                  </div>
                  <div>
            ...
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 hover:shadow-[0_0_36px_rgba(34,197,94,0.22)] transition-all duration-300 hover:-translate-y-1 backdrop-blur-md">
              <div className="h-1 rainbow-bar opacity-80" />
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-yellow-300 to-emerald-400 text-slate-950 w-12 h-12 rounded-full flex items-center justify-center mr-5 font-bold text-xl shrink-0 shadow-[0_0_14px_rgba(34,197,94,0.35)]">
                    2
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-slate-200">
                      ...
                      <li className="flex items-center">
                        <Coffee className="h-4 w-4 text-lime-300 mr-2" />
                        <span>Take a 10-minute walk when you feel the urge to scroll</span>
                      </li>
                      <li className="flex items-center">
                        <Coffee className="h-4 w-4 text-emerald-300 mr-2" />
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 hover:shadow-[0_0_36px_rgba(6,182,212,0.22)] transition-all duration-300 hover:-translate-y-1 backdrop-blur-md">
              <div className="h-1 rainbow-bar opacity-80" />
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-cyan-400 to-blue-400 text-slate-950 w-12 h-12 rounded-full flex items-center justify-center mr-5 font-bold text-xl shrink-0 shadow-[0_0_14px_rgba(6,182,212,0.35)]">
                    3
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-slate-200">
                      ...
                      <li className="flex items-center">
                        <Activity className="h-4 w-4 text-blue-300 mr-2" />
            ...
            <Card className="rainbow-border rainbow-glow overflow-hidden border-0 bg-slate-950/70 hover:shadow-[0_0_36px_rgba(139,92,246,0.22)] transition-all duration-300 hover:-translate-y-1 backdrop-blur-md">
              <div className="h-1 rainbow-bar opacity-80" />
              <CardContent className="p-8">
                <div className="flex items-start">
                  <div className="bg-gradient-to-br from-indigo-400 to-fuchsia-400 text-slate-950 w-12 h-12 rounded-full flex items-center justify-center mr-5 font-bold text-xl shrink-0 shadow-[0_0_14px_rgba(139,92,246,0.35)]">
                    4
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-slate-200">
                      <li className="flex items-center">
                        <Coffee className="h-4 w-4 text-indigo-300 mr-2" />
